...
class DumpOutputDev : public OutputDev {
public:
  GfxFont *lastFont;
...
class FullDumpOutputDev : public OutputDev {
public:
  ...
  GBool checkPageSlice(Page * page, double hDPI, double vDPI, int rotate,
    ...
    int sliceW, int sliceH, GBool printing, GBool (*abortCheckCbk)(void *) ,
    void * abortCheckCbkData, GBool (*annotDisplayDecideCbk)(Annot *, void *) , void * annotDisplayDecideCbkData) {
    printf("checkPageSlice\n");
    return OutputDev::checkPageSlice(page, hDPI, vDPI, rotate, useMediaBox, crop, sliceX, sliceY, sliceW, sliceH, printing, abortCheckCbk, abortCheckCbkData, annotDisplayDecideCbk, annotDisplayDecideCbkData);
  }
  ...
  GBool tilingPatternFill(GfxState * A, Gfx * B, Catalog * C, Object * D, double * E, int F, int G, Dict * H, double * I, double * J, int K, int L, int M, int N, double O, double P) {
    ...
    return OutputDev::tilingPatternFill(A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P);
  }
  ...
  void drawImageMask(GfxState * state, Object * ref, Stream * str, int width, int height, GBool invert, GBool interpolate, GBool inlineImg) {
    printf("drawImageMask\n");
    return OutputDev::drawImageMask(state, ref, str, width, height, invert, interpolate, inlineImg);
  }
  ...
  void setSoftMaskFromImageMask(GfxState * state, Object * ref, Stream * str, int width, int height, GBool invert, GBool inlineImg, double * baseMatrix) {
    printf("setSoftMaskFromImageMask\n");
    return OutputDev::setSoftMaskFromImageMask(state, ref, str, width, height, invert, inlineImg, baseMatrix);
  }
  ...
  void drawMaskedImage(GfxState * state, Object * ref, Stream * str, int width, int height, GfxImageColorMap * colorMap, GBool interpolate, Stream * maskStr, int maskWidth, int maskHeight, GBool maskInvert, GBool maskInterpolate) {
    printf("drawMaskedImage\n");
    return OutputDev::drawMaskedImage(state, ref, str, width, height, colorMap, interpolate, maskStr, maskWidth, maskHeight, maskInvert, maskInterpolate);
  }
  ...
  void drawSoftMaskedImage(GfxState * state, Object * ref, Stream * str, int width, int height, GfxImageColorMap * colorMap, GBool interpolate, Stream * maskStr, int maskWidth, int maskHeight, GfxImageColorMap * maskColorMap, GBool maskInterpolate) {
    printf("drawSoftMaskedImage\n");
    return OutputDev::drawSoftMaskedImage(state, ref, str, width, height, colorMap, interpolate, maskStr, maskWidth, maskHeight, maskColorMap, maskInterpolate);
  }
