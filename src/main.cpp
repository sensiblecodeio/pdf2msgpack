...
static int install_syscall_filter(void) {
  ...
  struct sock_filter filter[] = {
      ...
      ALLOW_SYSCALL(access), ALLOW_SYSCALL(fstatfs), ALLOW_SYSCALL(readlink),
      ALLOW_SYSCALL(open), ALLOW_SYSCALL(close), ALLOW_SYSCALL(ioctl),
      ALLOW_SYSCALL(fcntl), ALLOW_SYSCALL(getdents64), ALLOW_SYSCALL(read),
      ALLOW_SYSCALL(readv), ALLOW_SYSCALL(pread64), ALLOW_SYSCALL(write),
      ALLOW_SYSCALL(writev), ALLOW_SYSCALL(lseek), ALLOW_SYSCALL(futex),
      ALLOW_SYSCALL(time), ALLOW_SYSCALL(clock_gettime),
      ALLOW_SYSCALL(gettimeofday), ALLOW_SYSCALL(fstat), ALLOW_SYSCALL(stat),
      ALLOW_SYSCALL(mmap), ALLOW_SYSCALL(munmap), ALLOW_SYSCALL(madvise),
      ALLOW_SYSCALL(mremap), ALLOW_SYSCALL(brk), ALLOW_SYSCALL(exit),
